...
<CardGroup cols={2}>
  <Card title="ADP CLI 使用指南" icon="book" href="https://laiye-tech.feishu.cn/wiki/YIaawiK2DimisZk5KfDc8a8cnLh">
    CLI 文档
  </Card>
  <Card title="OpenAPI 使用指南" icon="file-lines" href="https://laiye-tech.feishu.cn/wiki/S1t2wYR04ivndKkMDxxcp2SFnKd">
    API 文档
  </Card>
  <Card title="公有云操作手册" icon="book-open" href="https://laiye-tech.feishu.cn/wiki/OfexwgVUQiOpEek4kO7c7NEJnAe">
    用户指南
  </Card>
