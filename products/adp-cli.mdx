...
<CardGroup cols={2}>
  <Card title="ADP CLI 使用指南" icon="book" href="/products/adp-cli">
    CLI 文档
  </Card>
  <Card title="OpenAPI 使用指南" icon="file-lines" href="/products/adp-api">
    API 文档
  </Card>
  <Card title="公有云操作手册" icon="book-open" href="/">
    用户指南
  </Card>
