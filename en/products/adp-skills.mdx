...
| --- | --- | --- |
| Chinese mainland | [adp.laiye.com](https://adp.laiye.com/) | `https://adp.laiye.com/` |
...
<AccordionGroup>
  <Accordion title="Cross-border procurement: overseas invoice processing">
...
<CardGroup cols="2">
  ...
  <Card title="Official website" icon="globe" href="https://laiye.com/">
    Laiye ADP website
  </Card>
