...
We’re excited to introduce a new **“****Out\-of\-the\-Box****” processing module** for Global Invoices, receipts, and purchase orders\. Unlike previous custom applications that require manual prompt configuration, this module is powered by industry\-tuned, universal models\.
